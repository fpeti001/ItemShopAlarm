...
public class KedvencekActivity extends Activity {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            Boolean hozzaadott=false;
                ...
                if (kedvencekarray.contains(nevee)){
                    ...
                    saveData(kedvencekarray,"kedvencekarray");
                    Toast.makeText(KedvencekActivity.this, (String)getText(R.string.you_will_get_alarm1)+word.getDefaultTranslation()+ (String)getText(R.string.you_will_get_alarm2), Toast.LENGTH_LONG).show();
                    hozzaadott=true;
                ...
                intent.setAction("com.toxy.NOTIFY");
                sendBroadcast(intent);
                if (hozzaadott)onBackPressed();
